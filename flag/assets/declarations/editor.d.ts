 ...
 * Gizmo(svg工具)
 */
declare module Editor.Gizmo {

    /**
     * 
     * @param svg Svg Element - The svg element which can move.
     * @param args The args will parse to callback, you can check which svg element is moved with the args.
     * @param opts  The options you can set
     ...
     */
    export function registerMoveSvg(svg: SVGElement, args: Object | Array, opts);
...
declare module Editor.Utils {
    ...
    module UuidUtils {
        ...
        /**
         * 壓縮後的 uuid 可以減小保存時的尺寸，但不能做為文件名（因為無法區分大小寫並且包含非法字符）。
         * 默認將 uuid 的後面 27 位壓縮成 18 位，前 5 位保留下來，方便調試。
         * 如果啟用 min 則將 uuid 的後面 30 位壓縮成 20 位，前 2 位保留不變。
         * @param uuid
         * @param min
         */
